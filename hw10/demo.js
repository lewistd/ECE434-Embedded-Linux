...
//const sheetID = '1w1Z7ZV-PAOpMizQL8bjN6rMcb6zisXuGpo2OiKt4axg';
const sheetID = '13leGjAAjqsvdhxEHl7JgL2eSIVC_jp8y2qlNVV8cH94';
...
function recordTemp(auth) {
  ...
  temp[0] = sensor.readByteSync(tmp101[0], 0x0);
  temp[1] = sensor.readByteSync(tmp101[1], 0x0);
  console.log("temp: %dC, %dF (0x%s)", temp[0], temp[0]*9/5+32, tmp101[0].toString(16));
  console.log("temp: %dC, %dF (0x%s)", temp[1], temp[1]*9/5+32, tmp101[1].toString(16));
  var var1 = temp[0]*9/5+32 //process.argv[2];
  var var2 = temp[1]*9/5+32 //process.argv[3];
